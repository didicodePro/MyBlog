...
/****** Object:  Database [MyBlogDB]    Script Date: 2025-03-21 12:23:00 PM ******/
CREATE DATABASE [MyBlogDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MyBlogDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\MyBlogDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MyBlogDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\MyBlogDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [MyBlogDB] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [MyBlogDB] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [MyBlogDB] SET READ_COMMITTED_SNAPSHOT ON 
GO

ALTER DATABASE [MyBlogDB] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [MyBlogDB] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [MyBlogDB] SET QUERY_STORE = ON
GO

ALTER DATABASE [MyBlogDB] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
